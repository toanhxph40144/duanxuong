                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ma_san_pham" name="ma_san_pham" class="form-control @error('ma_san_pham') is-invalid @enderror" value="{{ $sanPham->ma_san_pham }}" placeholder="Mã sản phẩm">
                                        @error('ma_san_pham')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="ten_san_pham" name="ten_san_pham" class="form-control @error('ten_san_pham') is-invalid @enderror" placeholder="Tên sản phẩm" value="{{$sanPham->ten_san_pham }}">
                                        @error('ten_san_pham')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        placeholder="Giá sản phẩm" value="{{$sanPham->gia_san_pham }}">
                                        @error('gia_san_pham')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai" class="form-control @error('gia_khuyen_mai') is-invalid @enderror" placeholder="Giá khuyến mãi" value="{{$sanPham->gia_khuyen_mai }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="so_luong" name="so_luong" class="form-control @error('so_luong') is-invalid @enderror" placeholder="Số lượng sản phẩm" value="{{ $sanPham->so_luong }}">
                                        @error('so_luong')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-switch mb-2 d-flex justify-content-between">
                                        ...
                                        <div class="form-check">
                                            ...
                                            name="{{ $field }}" id="{{ $field }}" {{ $sanPham->$field ? 'checked' : '' }}>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @enderror
                                        <div class="mt-2">
                                            <img id="imagePreview" src="{{Storage::url($sanPham->hinh_anh)}}"
                                             alt="Hình ảnh preview" style=" width:150px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10 d-flex gap-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_type"
                                             id="trang_thai_{{ $value }}" value="{{ $value }}" 
                                             {{ $sanPham->is_type == $value ? 'checked' : '' }}>
                                            <label class="form-check-label {{ $value == '1' ? 'text-success' : 'text-danger' }}"
                                             for="trang_thai_{{ $value }}">{{ $label }}</label>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Set initial content
        var oldContent = `{!! $sanPham->noi_dung !!}`;
        ...
        document.getElementById('add-row').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                <td class="d-flex align-item-center">
                    ...
                    src="https://uxwing.com/wp-content/themes/uxwing/download/video-photography-multimedia/pictures-icon.svg" 
                    alt="Hình ảnh sản phẩm" style="width: 40px; margin-right:6px;">
                    <input type="file" name="list_hinh_anh[id_${rowCount}]"
                     class="form-control" onchange="previewImage(this, ${rowCount})">
                </td>
                <td><i class="mdi mdi-delete text-muted fs-18 rounded-2 border p-1" 
                style="cursor:pointer" onclick="removeRow(this)"></i></td>
            `;
